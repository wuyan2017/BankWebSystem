...
<div id="RetailsPlan_page" data-options="region:'center',title:'还款详细计划',iconCls:'icon-ok'" >
    <table >
        <tr>
            ...
            <th data-options="field:'total',width:80,align:'right'">挂账金额</th>
            <th data-options="field:'plan',width:80,align:'right'">开始还款</th>
        </tr>
        <%
        ...
        <tr>
            <td width="100">1</td>
            <td width="100">2017-11-30</td>
            <td width="100"><%=total/n*30*0.003+total/n%></td>
            <td width="100"><%=guazhang%></td>
            <td width="100"><button onclick="window.location.href='/bank/BeginPay_page'">还款</button></td>
        </tr>
        <tr>
            <td width="100">2</td>
            <td width="100">2017-12-30</td>
            <td width="100"><%=total/n*30*0.003+total/n%></td>
            <td width="100"><%=guazhang2%></td>
            <td width="100"><button onclick="window.location.href='/bank/BeginPay_page'">还款</button></td>
        </tr>
        <tr>
            <td width="100">3</td>
            <td width="100">2018-01-30</td>
            <td width="100"><%=total/n*30*0.003+total/n%></td>
            <td width="100"><%=guazhang3%></td>
            <td width="100"><button onclick="window.location.href='/bank/BeginPay_page'">还款</button></td>
        </tr>
        <tr>
            <td width="100">4</td>
            <td width="100">2018-02-30</td>
            <td width="100"><%=total/n*30*0.003+total/n%></td>
            <td width="100"><%=guazhang4%></td>
            <td width="100"><button onclick="window.location.href='/bank/BeginPay_page'">还款</button></td>
        </tr>
        <tr>
            <td width="100">5</td>
            <td width="100">2018-03-30</td>
            <td width="100"><%=total/n*30*0.003+total/n%></td>
            <td width="100"><%=guazhang5%></td>
            <td width="100"><button onclick="window.location.href='/bank/BeginPay_page'">还款</button></td>
        </tr>
        <%}
        ...
        <tr>
            ...
            <td width="100"><%=guazhang+guazhang2+guazhang3%></td>
            <td width="100"><button onclick="window.location.href='/bank/BeginPay_page'">还款</button></td>
        </tr>
        <tr>
            <td width="100">2</td>
        ...
        <tr>
            ...
            <td width="100"><%=total3%></td>
            <td width="100"><%=guazhang+guazhang2+guazhang3%></td>
            <td width="100"><button onclick="window.location.href='/bank/BeginPay_page'">点击查看</button></td>
        </tr>
        <tr>
            <td width="100">4</td>
            <td width="100"><%=user.getLoan_time() %></td>
