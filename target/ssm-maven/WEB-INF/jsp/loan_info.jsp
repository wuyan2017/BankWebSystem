...
<div id="loanInfo_page" data-options="region:'center',title:'借款信息',iconCls:'icon-ok'" >
    <table >
        <tr>
            <th data-options="field:'no',width:80">借款次序</th>
            <th data-options="field:'time',width:100">借款时间</th>
            <th data-options="field:'total',width:80,align:'right'">借款金额</th>
            <th data-options="field:'plan',width:80,align:'right'">还款计划</th>
        </tr>
        <%
        ...
        %>
            <tr>
                ...
                <td width="100"><button onclick="window.location.href='/bank/pay_plan'">点击查看</button></td>
             </tr>
        <%}
